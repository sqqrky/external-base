...
namespace uemath {
	inline int m_width = GetSystemMetrics(0);
	inline int m_height = GetSystemMetrics(1);

	inline int m_width_center = m_width / 2;
	inline int m_height_center = m_height / 2;
